...
public class WorldProviderTier1 extends WorldProvider{
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderTier1(this.worldObj, this.worldObj.getSeed(), true);
	}
	...
	public void registerWorldChunkManager() {
		...
		this.dimensionId = References.TIER1_DIM;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(References.TIER1_DIM);
	}
	...
	public String getSaveFolder() {
			return "DIM" + References.TIER1_DIM;
	}
