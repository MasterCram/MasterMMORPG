package Master_Cram.Master_Mod.world.arcana.renderer;
...
public class ArcanaSkyRenderer extends IRenderHandler {

	private int starGLCallList;
	private int glSkyList;
	private int glSkyList2;

	public ArcanaSkyRenderer()
	{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc) {
		...
		mc.renderEngine.getTexture(new ResourceLocation("mm:/textures/environment/sun.png")); 
		...
		mc.renderEngine.bindTexture(new ResourceLocation("mm:/textures/environment/moon_phases.png"));
