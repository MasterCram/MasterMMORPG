...
public class WorldProviderTier4 extends WorldProvider{
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderTier4(this.worldObj, this.worldObj.getSeed(), true);
	}
	...
	public void registerWorldChunkManager() {
		...
		this.dimensionId = References.TIER4_DIM;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(References.TIER4_DIM);
	}
	...
	public String getSaveFolder() {
			return "DIM" + References.TIER4_DIM;
	}
