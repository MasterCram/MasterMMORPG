...
public class TeleporterVoidWorld extends Teleporter {
    ...
    public TeleporterVoidWorld(WorldServer p_i1963_1_)
    {
    	super(p_i1963_1_);
    ...
    public void placeInPortal(Entity p_77185_1_, double p_77185_2_, double p_77185_4_, double p_77185_6_, float p_77185_8_)
    {
        ...
        else
        {
            ...
            p_77185_1_.setLocationAndAngles((double)i, (double)j + 10, (double)k, p_77185_1_.rotationYaw, 0.0F);
	...
	public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
    {
        ...
        {
        	TeleporterVoidWorld.PortalPosition portalposition = (TeleporterVoidWorld.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        else
        {
            for (l3 = l - short1; l3 <= l + short1; ++l3)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlock(l3, i2, l1) == Master_Mod.itemManager.ironPortal)
                        {
                            while (this.worldServerInstance.getBlock(l3, i2 - 1, l1) == Master_Mod.itemManager.ironPortal)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new TeleporterVoidWorld.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
            ...
            if (this.worldServerInstance.getBlock(i - 1, j, k) == Master_Mod.itemManager.ironPortal)
            {
                i4 = 2;
            }
            ...
            if (this.worldServerInstance.getBlock(i, j, k - 1) == Master_Mod.itemManager.ironPortal)
            {
                i4 = 3;
            }
    ...
    public boolean makePortal(Entity p_85188_1_)
    {
        ...
        if (d0 < 0.0D)
        {
            ...
            for (i3 = -1 - 5; i3 <= 1 + 5; ++i3)
            {
                for (j3 = 1 - 5; j3 < 3 + 5; ++j3)
                {
                    for (k3 = -1; k3 < 3; ++k3)
                    {
                        l3 = k5 + (j3 - 1) * l5 + i3 * l2;
                        ...
                        j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                        flag = k3 < 0;
                        this.worldServerInstance.setBlock(l3, i4, j4, flag ? Blocks.bedrock : Blocks.air);
                    }
                }
            }
        }
        ...
        for (i3 = 0; i3 < 4; ++i3)
        {
            for (j3 = 0; j3 < 4; ++j3)
            {
                for (k3 = -1; k3 < 4; ++k3)
                {
                    ...
                    this.worldServerInstance.setBlock(l3, i4, j4, (Block)(flag ? Blocks.bedrock : Master_Mod.itemManager.ironPortal), 0, 2);
                }
            }
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                TeleporterVoidWorld.PortalPosition portalposition = (TeleporterVoidWorld.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
