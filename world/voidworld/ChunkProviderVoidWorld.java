...
public class ChunkProviderVoidWorld implements IChunkProvider {
	...
	public ChunkProviderVoidWorld(World world, long seed, boolean mapFeaturesEnabled)
	{
	...
	public Chunk provideChunk(int par1, int par2) {
		...
		Chunk chunk = new Chunk(this.worldObj, new Block[65536], new byte[65536], par1, par2);
