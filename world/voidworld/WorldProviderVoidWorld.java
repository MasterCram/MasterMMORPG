...
import Master_Cram.Master_Mod.world.renderer.CloudRenderer;
import Master_Cram.Master_Mod.world.renderer.SkyRenderer;
import Master_Cram.Master_Mod.world.renderer.WeatherRenderer;
...
public class WorldProviderVoidWorld extends WorldProvider{
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderVoidWorld(this.worldObj, this.worldObj.getSeed(), true);
	}
	...
	public void registerWorldChunkManager() {
		...
		this.dimensionId = References.VOID_WORLD;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(References.VOID_WORLD);
	}
	...
	public String getSaveFolder() {
			return "DIM" + References.VOID_WORLD;
	}
