...
public class WorldProviderTier2 extends WorldProvider{
	
	@Override
	/** tells Minecraft to use our new Terrain Generator */
	public IChunkProvider createChunkGenerator() {
		return new ChunkProviderTier2(this.worldObj, this.worldObj.getSeed(), true);
	}
	...
	public void registerWorldChunkManager() {
		...
		this.dimensionId = References.TIER2_DIM;
	}
	
	/** Get Provider for Dimension **/
	public static WorldProvider getProviderForDimension(int id)
	{
		return DimensionManager.createProviderFor(References.TIER2_DIM);
	}
	...
	public String getSaveFolder() {
			return "DIM" + References.TIER2_DIM;
	}
