...
public class BackpackInventory implements IInventory
{
	...
	public ItemStack getStackInSlot(int slot)
	{
		...
		{
			//ExtendedPlayer.get(player).backpackInventory.writeToNBT(ExtendedPlayer.get(player).inventory.getStackInSlot(3));
			//System.out.print("Saved nbt Data\n");
	...
	public void writeToNBT(ItemStack stack)
	{
		...
		NBTTagCompound compound = NBTHelper.loadStackNBT(stack);
		...
		NBTHelper.saveStackNBT(stack, compound);
	}
