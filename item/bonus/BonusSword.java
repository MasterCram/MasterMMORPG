...
import Master_Cram.Master_Mod.item.SwordUpgrades;
import net.minecraft.entity.SharedMonsterAttributes;
import net.minecraft.entity.player.EntityPlayer;
import net.minecraft.item.ItemStack;
import net.minecraft.nbt.NBTTagCompound;

public enum BonusSword {
	
	DEFAULT(new Attribute[] {}, 0, 1),
	COMMON(new Attribute[] {}, 0, 1),
	UNCOMMON(new Attribute[] {Attribute.ATTACK, Attribute.EXP, Attribute.LIFE, Attribute.MANA, Attribute.DURABILITY}, 2, 1),
	RARE(new Attribute[] {Attribute.ATTACK, Attribute.EXP, Attribute.LIFE, Attribute.MANA, Attribute.DURABILITY}, 3, 2),
	EPIC(new Attribute[] {Attribute.ATTACK, Attribute.EXP, Attribute.LIFE, Attribute.MANA, Attribute.DURABILITY}, 4, 3),
	LEGENDARY(new Attribute[] {Attribute.ATTACK, Attribute.EXP, Attribute.LIFE, Attribute.MANA, Attribute.DURABILITY}, 5, 4);
	...
	BonusSword(Attribute[] attributeList, int nbAttribute, float bonusMultiplicator){
	...
	public void addNewAttribute(EntityPlayer player, ItemStack stack, NBTTagCompound nbt) {
		...
		SwordUpgrades.updateSwordDamage(stack, nbt);
