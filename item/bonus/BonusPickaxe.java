...
public enum BonusPickaxe {
	
	DEFAULT(new Attribute[] {}, 0, 1),
	COMMON(new Attribute[] {}, 0, 1),
	UNCOMMON(new Attribute[] {Attribute.EXP, Attribute.DURABILITY, Attribute.EFFICIENCY}, 2, 1),
	RARE(new Attribute[] {Attribute.EXP, Attribute.DURABILITY, Attribute.EFFICIENCY}, 3, 2),
	EPIC(new Attribute[] {Attribute.EXP, Attribute.DURABILITY, Attribute.EFFICIENCY}, 4, 3),
	LEGENDARY(new Attribute[] {Attribute.EXP, Attribute.DURABILITY, Attribute.EFFICIENCY}, 5, 4);
	...
	BonusPickaxe(Attribute[] attributeList, int nbAttribute, float bonusMultiplicator){
