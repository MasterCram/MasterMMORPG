...
public class BigCaveGenerator extends MapGenCaves {
	...
	@Override
	protected void func_151538_a(World worldIn, int chunkX, int chunkZ, int p_180701_4_, int p_180701_5_, Block[] chunkPrimerIn) {
		...
		for(int j = 0; j < i; ++j) {
			...
			if(rand.nextInt(4) == 0) {
				func_151542_a(rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2);
				k += rand.nextInt(4);
			}
			...
			for(int l = 0; l < k; ++l) {
				...
				func_151541_a(rand.nextLong(), p_180701_4_, p_180701_5_, chunkPrimerIn, d0, d1, d2, f2, f, f1, 0, 0, 1.0D);
			}
		}
	}
